    ...
    <script>
        ...
        document.getElementById('addUserForm').addEventListener('submit', function(e) {
            ...
            .then(async response => {
                ...
                const successTitle = 'User Successfully Registered!';
                const successMessage = data.message || 'The user has been successfully registered and can now access the system.';
