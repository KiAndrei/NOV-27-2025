...
<body>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Document items horizontal layout mobile */
            .document-item.horizontal-layout {
                flex-direction: column;
                align-items: flex-start;
                gap: 12px;
        ...
        @media (max-width: 480px) {
            ...
            .document-item.horizontal-layout .btn-view,
            .document-item.horizontal-layout .btn-download {
                width: 2.2rem;
                height: 2.2rem;
                font-size: 0.9rem;
            }
                ...
                .then(documents => {
                    ...
                    if (documents.length === 0) {
                        ...
                        documentsList.innerHTML = documents.map(doc => {
                            // Get file extension from file_name to show correct icon
                            ...
                            <div class="document-item horizontal-layout">
                                <div class="document-icon">
                                    <i class="fas ${getFileIconClass(doc.file_name)}"></i>
                                </div>
                                <div class="document-info">
