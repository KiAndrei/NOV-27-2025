...
<head>
    ...
    <style>
        ...
        .fc-event {
            ...
            background: linear-gradient(135deg, #c76a7a, #a74d5f) !important;
        ...
        .fc-event:hover {
            ...
            background: linear-gradient(135deg, #b95b6c, #943b50) !important;
        }
...
<body>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Calendar buttons mobile - smaller size */
            .fc-header-toolbar {
                gap: 4px;
            ...
            /* Calendar day cells - make them readable */
        ...
        @media (max-width: 480px) {
            ...
            /* Calendar container ultra mobile */
            .calendar-container {
            ...
            /* Better scrollbar for ultra mobile */
            .calendar-container::-webkit-scrollbar {
                height: 8px;
            }
            ...
            /* Calendar buttons ultra mobile - even smaller */
            .fc-toolbar-title {
                font-size: 0.9rem !important;
            ...
            /* Stack toolbar on ultra mobile if needed */
            .fc-header-toolbar {
                flex-wrap: wrap;
                gap: 6px;
                justify-content: center;
            ...
            /* Make button text shorter on ultra mobile */
            .fc-today-button {
                font-size: 0.6rem !important;
            }

            /* Calendar day cells ultra mobile */
            .fc-daygrid-day-number {
                font-size: 0.8rem !important;
            ...
            /* Professional modal ultra mobile */
            .professional-modal {
                width: 100% !important;
