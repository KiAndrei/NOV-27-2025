    ...
    <style>
        * {
        ...
        @media (max-width: 480px) {
            ...
            #forgotPasswordModal > div > div:first-child h2 {
                font-size: 26px !important;
                margin-bottom: 12px !important;
            }

            #forgotPasswordModal > div > div:first-child h3 {
            ...
            #forgotPasswordModal > div > div:last-child button {
            ...
            #accountLockedModal h2 {
                font-size: 24px !important;
            }

            #accountLockedModal p {
                font-size: 14px !important;
            }

            #accountLockedModal button {
                padding: 12px 20px !important;
                font-size: 14px !important;
            }

            #accountLockedModal .fas.fa-lock {
                font-size: 28px !important;
            }

            #accountLockedModal > div > div:first-child > div:first-child {
